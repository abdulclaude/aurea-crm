  ...
  return (
    ...
    >
      <input
        ...
        data-slot="input"
        className={cn(
          "relative text-xs text-primary dark:text-neutral-200 bg-white dark:bg-neutral-750 placeholder:text-neutral-400 dark:placeholder:text-neutral-500 px-3.5 py-2 rounded-lg outline-none transition duration-150 hover:bg-primary-foreground/15 h-8.5! w-full ring ring-black/10",
          className,
        )}
      />
    </div>
