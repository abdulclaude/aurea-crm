...
export const CreateClientDialog: React.FC<Props> = ({
  open,
  onOpenChange,
  onSubmit,
  defaultValues = {},
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      acquisitionStage:
        defaultValues.acquisitionStage || "INQUIRY",
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <ResizableSheetContent className="overflow-y-auto sm:max-w-xl bg-background border-border">
        <SheetHeader className="px-6 p-6 pb-2 gap-1">
          <SheetTitle>Create Client Configuration</SheetTitle>
          <SheetDescription>
            Configure the client details to create in your CRM.
          </SheetDescription>
        </SheetHeader>
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    You can reference this client in other nodes using the
                    variable name.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <div className="grid grid-cols-3 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Acquisition Stage</FormLabel>
                    <Select value={field.value} onValueChange={field.onChange}>
                      <FormControl>
                        <SelectTrigger className="w-full text-xs">
                          <SelectValue placeholder="Select stage" />
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <VariableInput
                      value={field.value || ""}
                      onChange={field.onChange}
                      placeholder="intro, vip, at-risk or @variables"
                      variables={variables}
                    />
                  </FormControl>
                  <FormDescription className="text-xs">
                    Comma-separated tags to store on the client.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <VariableInput
                      value={field.value || ""}
                      onChange={field.onChange}
                      placeholder="Add an initial note for this client or @variables"
                      variables={variables}
                      className="h-24"
                    />
                  </FormControl>
