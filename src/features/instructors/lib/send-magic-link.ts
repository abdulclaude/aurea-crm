        ...
        <html>
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
              <h1 style="color: white; margin: 0; font-size: 24px;">Welcome, ${instructorName}!</h1>
            </div>
            ...
            <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <p style="font-size: 14px; color: #666; margin-bottom: 25px;">
                ${organizationName ? `${organizationName} has invited you` : "You've been invited"} to join as an instructor. Click the button below to set up your account and access your dashboard.
              </p>
