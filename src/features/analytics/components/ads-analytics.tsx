  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <DateRangePicker
          value={{
            from: parseDateValue(dateRange.startDate),
            to: parseDateValue(dateRange.endDate),
          }}
          onChange={(range) => {
            if (!range?.from) return;
            setDateRange({
              startDate: formatDateValue(range.from),
              endDate: formatDateValue(range.to ?? range.from),
            });
          }}
          minDate={new Date(2020, 0, 1)}
          maxDate={new Date()}
          ariaLabel="Advertising analytics date range"
          className="w-64"
          clearable={false}
        />
      ...
      {loadingSummary ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="p-4">
            ...
            <div
              className={`text-2xl font-bold ${summary.profit >= 0 ? "text-green-500" : "text-red-500"}`}
            >
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span>
                        {attribution.firstTouch.conversions.facebook}{" "}
                        conversions
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span>
                        {attribution.firstTouch.conversions.google} conversions
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>TikTok:</span>
                      <span>
                        {attribution.firstTouch.conversions.tiktok} conversions
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Direct:</span>
                      <span>
                        {attribution.firstTouch.conversions.direct} conversions
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span>Meta/Facebook:</span>
                      <span>
                        {attribution.lastTouch.conversions.facebook} conversions
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Google Ads:</span>
                      <span>
                        {attribution.lastTouch.conversions.google} conversions
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>TikTok:</span>
                      <span>
                        {attribution.lastTouch.conversions.tiktok} conversions
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Direct:</span>
                      <span>
                        {attribution.lastTouch.conversions.direct} conversions
                      </span>
                    </div>
                  </div>
                </div>
